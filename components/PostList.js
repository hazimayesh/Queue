...
import PostDownvoterS from './PostDownvoterS'
          ...
          {allPosts.map((post, index) =>
              ...
              <Card key={post.id}>
                ...
                <Card.Content>
                  ...
                  <Card.Meta>
        <span className='date'>
            Approximately {post.votes*3} minutes
        </span>
                  </Card.Meta>
                  <Card.Description>
                    <PostUpvoter votes={post.votes} id={post.id} active={post.active}/>
                    <PostDownvoterS votes={post.votes} id={post.id} active={post.active}/>
                ...
                <Card.Content extra>
                  <a >
                    ...
                    <Statistic>
                      <Statistic.Label>Your Number in the Queue is </Statistic.Label>
